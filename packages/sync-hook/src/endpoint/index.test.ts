...
vi.mock('../../../common/src/services/localazy-api-throttle-service', () => ({
...
vi.mock('../../../common/src/services/orchestrator/incremental-import-orchestrator', () => ({
...
vi.mock('../../../common/src/services/synchronization-languages-service', () => ({
